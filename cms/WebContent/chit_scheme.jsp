...
<style>
#paraframe{width:900px; height:450px;left:150px; position:absolute; top:155px; right:10px; border:1px solid #DCDAC2; background:#fff;color:#3D3C2C;}
...
#parabody p{padding:0 80px 30px;}
...
<!-- .........................................TOP LINE ENDS...................................... -->
<div id="header"><a href="main-index.html"><img src="css/images/logo.jpg"  border="0"/></a>
	<ul>
		...
		<li><a href="#" title="Join Us"><img src="css/images/join.jpg" style="width:60px; height:60px;"/></a></li>
		<li><a href="features.jsp" title="Features"><img src="css/images/features.jpg" style="width:60px; height:60px;"/></a></li>
		<li><a href="#" title="Enquiry"><img src="css/images/enquire.png" style="width:60px; height:60px;"/></a></li>
...
<div class="plans">
    ...
    <div class="plan plan-tall">
      ...
      <p class="plan-price">R 10,000</p>
      <ul class="plan-features">
        <li><strong>10</strong> Groups</li>
        <li><strong>Unlimited</strong> Members</li>
        <li><strong>2 Years</strong> Validity</li>
      </ul>
      
    </div>
    <div class="plan">
      <h2 class="plan-title">Diamond</h2>
      <p class="plan-price">R 15,000</p>
      <ul class="plan-features">
        <li><strong>15</strong> Groups</li>
        <li><strong>Unlimited</strong> Members</li>
        <li><strong>2 Years</strong> Validity</li>
      </ul>
