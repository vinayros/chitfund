...
<img src="images/fu.jpg" style="
    ...
    <tr>
            <td valign="middle">
              ...
              <td valign="top">
            <input name="txtEmail" type="text" id="txtEmail" name="txtEmail" placeholder="Your email" />
           <span id="emailInfo"></span>
           </td>
           </tr>
           <tr>
    <td valign="middle">
          <font color="green"><b>Password*</b></font>
   </td>
  <td valign="top">
 <input name="useridf" type="Password" id="txtName" name="txtName" placeholder="Password" autofocus="" />
...
<tr>
    ...
    <div align="right">
     	<input type="submit" name="cmdSave" value="Get My Id" id="cmdSave" style="margin-right: 15px;" />
     </div>
    </td>
    </tr>
