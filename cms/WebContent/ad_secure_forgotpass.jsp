...
<div id="login">
	...
	<form class="boxCont" method="POST">
		<div>
			...
			<input id="userName" type="text" name="userName" placeholder="your username here" />
		</div>
		<div>
			<label for="userName">Email Id</label>
			<input id="userName" type="text" name="userName" placeholder="EmailId" />
		</div>
	...
	<a href="ad_secure_login.jsp" id="forgotpass">Back to Login</a>
</div>
</body>
</html>